...
```
[root@MiCloudDBT /home/user]# svcadm]([root@MiCloudDBT /home/user# svcadm)
...
```
svcadm enable [軟體名稱]](svcadm enable [軟體名稱)
...
```
svcadm disable [軟體名稱]](svcadm disable [軟體名稱)
...
```
svcadm restart [軟體名稱]](svcadm restart [軟體名稱)
